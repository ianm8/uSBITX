 ...
 * XTAL 27.000 Mhz
 *****************************************************************************/
 bool __not_in_flash_func(Si5351mcu::init)(void) {
 ...
 *****************************************************************************/
bool __not_in_flash_func(Si5351mcu::init)(uint32_t nxtal) {
 ...
 ****************************************************************************/
void __not_in_flash_func(Si5351mcu::setFreq)(uint8_t clk, uint32_t freq, const bool fast)
{
  ...
  ****************************************************************************/
  ...
  else 
  {
    if (fast)
    {
      i2cWriteBurst(26 + pll_stride + 4, reg_bank_26 + 4, 4);
    }
    else
    {
      i2cWriteBurst(26 + pll_stride, reg_bank_26, sizeof(reg_bank_26));
 ...
 ****************************************************************************/
void __not_in_flash_func(Si5351mcu::reset)(void) {
 ...
 * enable an output.
 ****************************************************************************/
void __not_in_flash_func(Si5351mcu::off)(void) {
 ...
 ****************************************************************************/
void __not_in_flash_func(Si5351mcu::correction)(int32_t diff) {
 ...
 *****************************************************************************/
void __not_in_flash_func(Si5351mcu::enable)(uint8_t clk) {
 ...
 * *****************************************************************************/
void __not_in_flash_func(Si5351mcu::disable)(uint8_t clk) {
    // send
 ...
 ***************************************************************************/
void __not_in_flash_func(Si5351mcu::setPower)(uint8_t clk, uint8_t power) {
 ...
 ***************************************************************************/
uint8_t __not_in_flash_func(Si5351mcu::i2cWriteBurst)( const uint8_t start_register, 
                                const uint8_t *data, 
 ...
 ***************************************************************************/
void __not_in_flash_func(Si5351mcu::i2cWrite)( const uint8_t regist, const uint8_t value) {
 ...
 ***************************************************************************/
int16_t  __not_in_flash_func(Si5351mcu::i2cRead)( const uint8_t regist ) {
    int value;
